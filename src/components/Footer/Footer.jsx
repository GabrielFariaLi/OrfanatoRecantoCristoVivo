        ...
        <div className="containerConteudosFooter">
          ...
          <div className="miniMenuFooter">
            ...
            <div className="primeiraParteMiniMenuFooter">
              <p className="itemMiniMenuFooter">Sobre nós</p>
              <p className="itemMiniMenuFooter">Faça sua doação</p>
              <p className="itemMiniMenuFooter">Seja um voluntário</p>
              <p className="itemMiniMenuFooter">Projetos </p>
            </div>
            <div className="segundaParteMiniMenuFooter">
              <p className="itemMiniMenuFooter">Nossa infraestrutura</p>
              <p className="itemMiniMenuFooter">Nossa equipe</p>
              <p className="itemMiniMenuFooter">Fale conosco</p>
            </div>
          </div>
