...
import "./HeroSectionDoacaoPorItem.css";

const HeroSectionDoacaoPorItem = () => {
  useEffect(() => {
      ...
      <div className="containerPrincipalHeroSectionDoacaoPorPix">
        <div className="containerTextoHeroSectionDoacaoPorPix">
          <p className="paragrafoDoacaoPorPixHero">
            Doe qualquer valor através do cartão
          </p>
          <h1 className="h1DoacaoPorPixHero">Sua doação</h1>
          <h1 className="h1DoacaoPorPixHero italic">muda vidas.</h1>
        </div>
        <div className="containerShippingBoxHeroSectionDoacaoItem">
          <img src="/imgs/shippingBoxDoacaoItem.png" />
        </div>
        <div className="containerButtonHeroSectionDoacaoItem">
          <p
            style={{ textAlign: "center" }}
            className="paragrafoDoacaoPorPixHero"
          >
            Não sabe o que doar?
          </p>
          <div className="buttonNaoSabeOqueDoarHeroDoacaoItem">
...
export default HeroSectionDoacaoPorItem;
