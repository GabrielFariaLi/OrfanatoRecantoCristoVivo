...
import "./TitulosOrfanatoSobreNos.css";
import gsap from "gsap";
const TitulosOrfanatoSobreNos = () => {
  useEffect(() => {
    gsap.utils.toArray(".stb_line_singleTitulosSobreNos").forEach((line, i) => {
...
export default TitulosOrfanatoSobreNos;
